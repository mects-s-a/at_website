...
function Modal({ card, onClose, onSuccess }) {
  ...
  const inputCls = "w-full border border-at-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-at-mid/20 focus:border-at-mid transition-all text-at-ink";
  ...
  return (
    ...
    >
      <div className="modal-in bg-white rounded-2xl shadow-at-lg w-full max-w-md overflow-hidden">

        {/* Header */}
        <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-at-border">
          <div className="flex items-center gap-2.5">
            <card.Icon size={20} style={{ color: card.iconColor }} strokeWidth={2} />
            <h2 className="font-bold text-at-ink text-lg">{card.modalTitle}</h2>
          </div>
          <button onClick={onClose} className="text-at-muted hover:text-at-ink transition-colors">
            <X size={20} />
          </button>
        </div>
        ...
        <div className="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
          {[
            ...
            <div key={key}>
              <label className="block text-sm font-semibold text-at-ink mb-1.5">
          ...
          <div>
            ...
            <label className="flex items-center gap-2.5 cursor-pointer">
              ...
              <span className="text-xs text-at-muted truncate max-w-[160px]">
        ...
        {/* Submit */}
        <div className="px-6 pb-6 pt-2 border-t border-at-border">
          <button
            onClick={submit}
            disabled={sending}
...
export default function CanalDoOuvinte() {
  ...
  return (
    <>
      ...
      <section className="py-10 sm:py-14 bg-at-deep text-white">
