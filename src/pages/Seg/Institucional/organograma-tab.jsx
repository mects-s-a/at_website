  ...
  return (
    <div className="space-y-6">
      ...
      <p className="section-desc">
        Árvore oficial de coordenação e dependência diretiva da instituição.
      </p>
      ...
      <div className="card" style={{ padding: "40px 20px" }}>
        <div className="orgchart">
          ...
          <div className="org-row" style={{ gap: "12px" }}>
            {["Recursos Humanos", "Planificação e Estudos", "Sistemas de Informação"].map(
              (ds, i) => (
                <div
                  className="org-node"
                  style={{ minWidth: "180px", padding: "10px 16px" }}
                  key={i}
                >
                  <span style={{ fontSize: "12px", fontWeight: 600, color: "var(--sat-fg)" }}>
                    Direcção de {ds}
                  </span>
                </div>
              )
