...
const aduaneiraLegis = {
  ...
  instrucoes: [
    { id: "is-trânsito", sigla: "IS", nome: "Instruções de Serviço sobre Trânsito de Mercadorias e ECTS", leis: ["Diploma Ministerial n.º 45/2021"] }
  ]
};
...
export default function AduaneiraContent() {
  ...
  const activeCat = queryParams.get("cat") || "codigo"; // 'codigo' é o padrão para Aduaneira
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3 bg-white p-3 rounded-xl border border-border shadow-sm">
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder="Pesquise na legislação aduaneira..."
