  ...
  return (
    <aside style={{ width: "320px", flexShrink: 0 }}>
      <div
        ...
        style={{ position: "sticky", top: "88px", minHeight: "calc(100vh - 140px)" }}
      >
              ...
              <div key={section.id} className="overflow-hidden rounded-xl border border-transparent bg-muted/5">
                <button
                  ...
                  className={[
                    ...
                    isParentActive ? "text-primary bg-primary/5" : "text-foreground/85",
                  ].join(" ")}
                >
                  ...
                  <ChevronDown className={"w-4 h-4 shrink-0 text-muted-foreground/70 transition-transform duration-200 " + (isOpen ? "transform rotate-180 text-primary" : "")} />
                </button>
                <div className={"transition-all duration-200 ease-in-out overflow-hidden pl-8 pr-3 space-y-1 " + (isOpen ? "max-h-60 pt-2 pb-4 opacity-100" : "max-h-0 opacity-0")}>
                    ...
                    return (
                      <Link
                        ...
                        className={[
                          ...
                          isSubActive ? "border-primary text-primary font-semibold bg-primary/5" : "border-transparent text-muted-foreground hover:text-foreground hover:bg-muted",
                        ].join(" ")}
                      >
