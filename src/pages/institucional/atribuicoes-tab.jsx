    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {competencias.map((item, idx) => (
          <div key={idx} className="bg-slate-50/50 border border-slate-100 rounded-2xl p-6 transition-all duration-200 hover:bg-white hover:border-slate-200 hover:shadow-sm space-y-4 flex flex-col h-full group">
            ...
            <div className="space-y-1.5 flex-1">
              <h3 className="text-base md:text-lg font-bold text-slate-900 tracking-tight leading-tight">{item.title}</h3>
